...
Screenshot3.png
  ...
  -Packet 479, 485–486 (QUIC Traffic): High-speed, encrypted UDP-based traffic (QUIC) is observed between a local host and a remote server. The "Protected Payload" 
   indicates data transfer within an established session, typically used for low-latency web applications.
